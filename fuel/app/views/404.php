...
<head>
    ...
    <title>Codestr - Freelance Las Vegas Web Developer</title>
    <?php echo $styles; ?>
</head>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="social-icons">
                        <li><a href="https://twitter.com/carb0nknight" target="_blank"><i class="fa fa-twitter"></i></a></li>
                    ...
                    <img class="section-intro-image" src="images/jedi.png" alt="Jedi" />
                    <h1 class="section-intro-h1">Whoops.</h1>
                    <h2 class="section-intro-h2">...this is not the page you're looking for...</h2>
                </div>
            </div>
        </div>
    </section>
